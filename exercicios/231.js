...
console.log(`A media de idade e das pessoas que digitou otimo ${resultado.media}`);
console.log(`O numero de pessoas que digitou regular foi ${resultado.contador}`);
