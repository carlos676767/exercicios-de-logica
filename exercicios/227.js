...
function valorCompras() {
    ...
    for (let i = 1; i < 15; i++) {
        ...
        let fazerCompras = prompt(`Para compras a vista use [V] para compras a prazo [P]`)
        ...
        switch (fazerCompras) {
            ...
            case "v":
                ...
                let custoCompraAvista = parseInt(prompt(`[AVISTA] Digite o valor de um produto`))
                //soma os valores 
                ...
                case "p":
                    ...
                    let custoCompraAprazo = parseInt(prompt(`[aprazo] Digite o valor de um produto`)) 
